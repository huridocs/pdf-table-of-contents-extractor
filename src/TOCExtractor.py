    ...
    def to_dict(self):
        ...
        for toc_item in self.toc:
            ...
            for selection_rectangle in toc_item.selectionRectangles:
                rectangle = dict()
                rectangle["left"] = int(selection_rectangle.left)
                rectangle["top"] = int(selection_rectangle.top)
                rectangle["width"] = int(selection_rectangle.width)
                rectangle["height"] = int(selection_rectangle.height)
